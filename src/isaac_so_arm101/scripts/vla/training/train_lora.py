"""LoRA fine-tuning for OpenVLA on JSONL or LeRobot datasets.

This script performs parameter-efficient fine-tuning using LoRA adapters.
It saves only the LoRA weights to --output_dir (not the full model).
