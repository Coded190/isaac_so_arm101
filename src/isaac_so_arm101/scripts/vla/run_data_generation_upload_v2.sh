...
echo "============================================================"
echo "[STEP 1] Running Data Generation (v2) -> $DATASET_ROOT"
echo "============================================================"
# v2 has the recording-branch kinematic improvements + multi-env-aware
# randomize_robot_root_pose. PhysX cosmetic warnings are dropped via 2>/dev/null.
uv run vla_data_gen_v2.py \
